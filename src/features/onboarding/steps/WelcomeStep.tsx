...
/** Step 1 — Globi introduces itself with a warm pulse ring. */
export function WelcomeStep({ animate = true }: { animate?: boolean }) {
  ...
  return (
    ...
    >
      <div className="relative flex size-[200px] items-center justify-center lg:hidden">
        {animate && (
      ...
      <h1
        ref={headingRef}
        tabIndex={-1}
        className="mt-3.5 text-[30px] font-black leading-[1.1] tracking-tight text-text outline-none lg:mt-0 lg:text-[38px]"
      >
        {t("onboarding.welcome.title")}
      </h1>
      <p className="mt-2.5 max-w-[26ch] text-[17px] font-medium leading-relaxed text-text-muted lg:max-w-[34ch] lg:text-lg">
